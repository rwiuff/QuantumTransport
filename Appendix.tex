...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{Figures/alphaimrealTE0.eps}
		\caption{Figure showing a plot of the Green's function at the 0th site}
		\label{0th}
	\end{subfigure}
	~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
	%(or a blank line to force the subfigure onto a new line)
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{Figures/alphaimrealTE4.eps}
	...
	%(or a blank line to force the subfigure onto a new line)
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{Figures/alphaimrealTE6.eps}
		\caption{Figure showing a plot of the Green's function at the 6th site}
		\label{6th}
	\end{subfigure}
	\caption{Three plots showing how the Green's function changes as the site is changed. The 0th, 4th and 6th sites are corresponding to atoms of those indices (0, 4, 6) in \cref{interface}. Note how the LDOS changes (imaginary part) for the different sites.}\label{siteLDOSplot}
\end{figure}
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.3\textwidth}
...
\begin{figure}
	\centering
	\includegraphics[width=.5\textwidth]{Figures/TestCell.eps}
	\caption{Plot showing the simple four-atom system with indices, used for the first tests of the recursion function.}
	\label{Testcell}
\end{figure}
...
\begin{figure}
	...
	\caption{Figure showing all the structures stated in \cref{testtable}. The number next to the figures correspond to the Test number in \cref{testtable}.}
	\label{Strucow}
\end{figure}
