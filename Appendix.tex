...
\begin{figure}
	...
	\begin{subfigure}[b]{0.3\textwidth}
		...
		\label{metabs}
	\end{subfigure}
	\caption{Plot showing band structures in the energy range \SI{-1.5}{\electronvolt} to \SI{1.5}{\electronvolt} for normal, para and meta NPG. The are plotted between symmetry points \(X\) and \(Y\) with respect to \(\Gamma\)}\label{allbands}
\end{figure}
