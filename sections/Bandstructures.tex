...
\begin{listing}[ht]
  \centering
  \im{Listings/Functions.py}{33}{40}
  \caption{The outer operator in numpy is manifested as two nested loops. On lines 35-37 each atomic distance is calculated. Line 38 replaces all nearest neighbour distances with an input potential, leaving the rest as zero. Lastly the diagonal is subtracted from the matrix.}
  \label{npouter}
\end{listing}
