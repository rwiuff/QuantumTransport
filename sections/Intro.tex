...
\begin{enumerate}
    \item \cref{theorysec,hamilsec,greensec,transec}
\end{enumerate}
...
\section{Hamiltonian for periodic systems}\label{}
\input{sections/Hamil.tex}
\section{Greens Functions, Self Energy and the Recursion Routine}\label{}
