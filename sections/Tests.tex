...
\begin{figure}[h]
    ...
    \caption{Figure showing the band structure obtained using DFT a), band structures obtained using developed program. One with no on-site potential mods (left) and one with the on-site potential changed to \SI{-0.5}{\electronvolt} (right). and a potential map of the system (below) }
    \label{PS4O}
\end{figure}
