...
%     \renewcommand\thesubfigure{\arabic{subfigure}}
    ...
    \begin{subfigure}[b]{0.9\textwidth}
	    ...
	    \label{studyfig3}
	\end{subfigure}
\caption{a: 1) showing the para NPG, 2) showing the meta NPG.\newline
2: Figure showing the currents through the GNR's in a large peace of NPG. Note how the current is spread across GNR's with the para bridge 1) and confined to a single GNR with meta bridge 2). Used with permission from Isaac Alcón Rovira.}
\label{studyfigs}
\end{figure}
