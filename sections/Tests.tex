...
\begin{figure}[ht]
	...
	begin{subfigure}[b]{0.25\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{Figures/PS4OHmo.eps}
		\vspace{-2\baselineskip}
		\caption{}
		\label{PS4OHremove}
	\end{subfigure}
