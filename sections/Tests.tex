...
\begin{figure}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		...
		\label{studyfig3}
	\end{subfigure}
	\caption{Figures obtained from  showing both the structures involved as well as some results obtained in the form of band structure and transmission plots.}
	\label{metapara}
\end{figure}
