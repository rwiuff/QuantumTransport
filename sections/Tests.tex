...
\begin{figure}[h]
    ...
    \label{PS4Odevmod}
    \end{subfigure}
    \caption{Figure showing band structures obtained using developed program.} 
    \label{PS4OHdev}
\end{figure}
