...
\begin{figure}[h]
    ...
    \label{PS4O}
\end{figure}
Following, in \cref{PS4Odev} band plots obtained with the developed program is shown. Firstly a band plot without any changes to the on-site potential and next a band plot where the on-site potential of the added sites have been change by an
\begin{figure}[h]
    \centering
