...
\begin{figure}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		...
		\label{studyfig3}
	\end{subfigure}
	\caption{Figures obtained from submitted article\cite{fan_redox_2017}, showing both the structures involved as well as some results obtained in the form of band structure and transmission plots.}
	\label{metapara}
\end{figure}
...
\begin{figure}[h]
	...
	\hspace{4pt}
	\begin{subfigure}[b]{0.8\textwidth}
		\includegraphics[width=\textwidth]{Figures/MS2Opotmap.eps}
		\vspace{-0.5\baselineskip}
		\hspace{-50pt}
		\caption{}
		\label{potmapM2SO}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{0.8\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Figures/MS2OH.eps}
		\vspace{-0.5\baselineskip}
		\hspace{-50pt}
		\caption{}
		\label{potmapMS2OH}
