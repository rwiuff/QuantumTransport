...
\begin{figure}
    ...
    \caption{Figure showing the currents through the GNR's in a large peace of NPG. Note how the current is spread across GNR's for the para bridge (a) and confined to a single GNR with meta bridge confined }
    \label{studyfig3}
    \end{subfigure}
