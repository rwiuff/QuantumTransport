...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption{Figure showing the band structures obtained using DFT/TBtrans (above) and a potential map of the}
    \label{PS4O}
\end{figure}
