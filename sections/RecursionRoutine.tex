...
\begin{listing}[ht]
    ...
    \label{plotcode}
\end{listing}
The output from this loop will be the real and imaginary y-values for the plot. These will have to be sorted to imaginary and real parts before plotting. The 
