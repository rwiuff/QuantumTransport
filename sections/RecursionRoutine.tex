...
\end{align}
Where \(\eta\) is a small number ensuring that the equation does not diverges when we use the numerical recursion routine described later on. \textit{E} is the energy for which we are probing the system.
