...
\begin{listing}
    \begin{minipage}[t]{.2\textwidth}
        \im{Listings/Functions.py}{1}{6}
    \end{minipage}
\end{listing}
\begin{listing}
    \begin{minipage}[t]{.2\textwidth}
        \im{Listings/Functions.py}{6}{10}
    \end{minipage}
...
As a good way to check whether the recursion routine has been implemented successfully, the real and imaginary part of the Green's function can be plotted. With a relatively simple approach, the Green's function can be obtained as a function of energy, using a 'for loop', looping over the function \cref{recursionfunc} (see \cref{plotcode}:
\begin{listing}[ht]
