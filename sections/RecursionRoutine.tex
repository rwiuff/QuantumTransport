...
\noindent
\begin{listing}\begin{minipage}[t]{.45\textwidth}\im{Listings/Functions.py}{1}{6}\end{minipage}\end{listing}\begin{listing}\begin{minipage}[t]{.45\textwidth}\im{Listings/Functions.py}{6}{10}\end{minipage}\end{listing}
\\
