...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\caption{Figure showing the simple system. Every atom in the unit cell has an index, here from 0 to 7. The blue and red colours mark the left and right contacts of the system. The}
		\label{pointplot}
	\end{subfigure}
