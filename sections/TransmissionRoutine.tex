...
\begin{figure}[ht]
    \centering
    \includegraphics[width =0.5\textwidth]{Figures/bands.eps}
    \caption{Transmission plot for the system in \cref{interface}}
\end{figure}