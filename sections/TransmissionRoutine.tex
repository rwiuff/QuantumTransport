...
Notice how the data is saved in dicts (\textit{GD}, \textit{GammaL}, \textit{GammaR}). This makes it easier to index later on, compared to, at this point, 3-dimensional arrays. Dicts uses strings as lookupkeys, and this can for example be seen in line 225 as:
