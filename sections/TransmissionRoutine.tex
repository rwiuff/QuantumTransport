...
\end{align} 
Looking back at \cref{transformal} the Green's function needed has been obtained, but what about the states going in and out of the device region \(\bra{m}\ \text{and}\ \ket{n}\)? As states travel, their corresponding selfenergies, change in tiFirst thing needed to describe how the density of states pass through is by which rate they pass. To do this the rate operators \(\mathbf{\Gamma}_L,\mathbf{\Gamma}_R\) are introduced... They are given by
