...
\begin{figure}
    ...
    \caption{Illustration showing how the different parts of the system are translated into matrix blocks. On the graphene the green box which includes one red and blue box is the device and so }
    \label{systemillu}
\end{figure}
