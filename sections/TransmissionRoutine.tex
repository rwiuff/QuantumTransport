...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{\textwidth}
	    \centering
	    \includegraphics[width=0.35\textwidth]{NPGNormal_pi-half}
		\qquad
	...
	\begin{subfigure}[b]{\textwidth}
	    \centering
	    \includegraphics[width=0.35\textwidth]{NPGNormal_pi}
		\qquad
	...
	\begin{subfigure}[b]{\textwidth}
	    \centering
	    \includegraphics[width=0.35\textwidth]{NPGNormal_AVER}
		\qquad
