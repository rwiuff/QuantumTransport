...
\end{align}
If symmetric in time (\(\mathbf{G}=\mathbf{G}^{T}\)) the change in the imaginary Green's matrix is defined as
\begin{align}
    \mathbf{A} &= i(\mathbf{G}-\mathbf{G}^{\dagger})\\
    &= i(\mathbf{G}^{\dagger}\left[\mathbf{G}^{\dagger}-\mathbf{G}\right]\mathbf{G})\nonumber\\
    &= i(\mathbf{G}^{\dagger}[\mathbf{\varepsilon}-\mathbf{H}^{\dagger}-\mathbf{Sigma}^{\dagger} - (\mathbf{\varepsilon} -\mathbf{H}-\mathbf{\Sigma})]\mathbf{G})\nonumber\\
    &=i(\mathbf{G}^{\dagger}[-\mathbf{\Sigma}^{\dagger}+\mathbf{\Sigma})]\mathbf{G})\nonumber\\
    &=i(\mathbf{G}^{\dagger}\mathbf{\Gamma}\mathbf{G})
\end{align}
Where \(\mathbf{\varepsilon}\) is the on
