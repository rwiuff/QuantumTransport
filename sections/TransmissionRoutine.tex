...
\begin{figure}
    ...
    \caption{Illustration showing how the different parts of the system are translated into matrix blocks. On the graphene the green box which includes one red and blue box is the device and so it can be translated in to a hamiltonian }
    \label{systemillu}
\end{figure}
