...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=0.36\textwidth]{Figures/NPGNormal_0.eps}
		\qquad
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=0.36\textwidth]{Figures/NPGNormal_pi-half.eps}
		\qquad
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=0.36\textwidth]{Figures/NPGNormal_pi.eps}
		\qquad
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=0.36\textwidth]{Figures/NPGNormal_AVER.eps}
		\qquad
		\includegraphics[width=0.35\textwidth]{Figures/txy_AVER.eps}
		\caption{Average over k-points \(0,\ \dfrac{\pi}{2},\ \pi \)}
		\label{piavg}
	\end{subfigure}
	\caption{Figure showing the comparison between plots of transmission through NPG obtained using the developed scripts (left/blue) and obtained using DFT (right/green).\newline
		Used with permission from Isaac Alcón Rovira.}\label{transmissionplots}
\end{figure}
In \cref{transmissionplots} transmission plots obtained with the script described in \cref{trans2d} is compared with transmission plot obtained through DFT, using the same k-points.
