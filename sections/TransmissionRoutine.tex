...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{\textwidth}
        \centering
		\includegraphics[height=0.35\textwidth]{Figures/NPGNormal_0.eps}
		\qquad
		\includegraphics[height=0.35\textwidth]{Figures/txy_0.eps}
	...
	\begin{subfigure}[b]{\textwidth}
	    \centering
	    \includegraphics[width=0.35\textwidth]{Figures/NPGNormal_pi-half.eps}
		\qquad
	...
	\begin{subfigure}[b]{\textwidth}
	    \centering
	    \includegraphics[width=0.35\textwidth]{Figures/NPGNormal_pi.eps}
		\qquad
	...
	\begin{subfigure}[b]{\textwidth}
	    \centering
	    \includegraphics[width=0.35\textwidth]{Figures/NPGNormal_AVER.eps}
		\qquad
