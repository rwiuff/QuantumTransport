...
\section{Tight-binding, Self-energy, Green's functions and Transmission}
\subsection{Quantum transport}
\input{sections/Theory.tex}
\subsection{Hamiltonian for periodic systems}
\input{sections/Hamil.tex}
\subsection{Self Energy, Greens Functions and the Recursion Routine}
\input{sections/RecursionRoutine.tex}
\subsection{Transmission Routine}
\input{sections/TransmissionRoutine.tex}
\section{Python Implementation}
\section{Exploring functionality of nano-ribbon bridges}
